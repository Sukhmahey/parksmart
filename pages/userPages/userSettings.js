...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector(".settingsContainer:nth-of-type(1) .edit-btn")
        .addEventListener("click", () => toggleEdit("account"));

    document.querySelector(".settingsContainer:nth-of-type(1) .save-btn")
        .addEventListener("click", () => saveChanges("account"));

    // Event listeners for 'Car' section
    document.querySelector(".settingsContainer:nth-of-type(2) .edit-btn")
        .addEventListener("click", () => toggleEdit("car"));

    document.querySelector(".settingsContainer:nth-of-type(2) .save-btn")
